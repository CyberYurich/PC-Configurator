...
ConfiguratorWidget::ConfiguratorWidget(QWidget *parent, const int countOfComponents) :
    QWidget(parent), ui(new Ui::ConfiguratorWidget), arrayCount(countOfComponents)
{
    ui->setupUi(this);
    ...
    connect(ui->lineEdit_cost_MB, SIGNAL(textChanged(QString)),
            this, SLOT(calculate_lineEdit_cost_All(QString)));
    connect(ui->lineEdit_cost_Case, SIGNAL(textChanged(QString)),
            this, SLOT(calculate_lineEdit_cost_All(QString)));
    connect(ui->lineEdit_cost_CPU, SIGNAL(textChanged(QString)),
            this, SLOT(calculate_lineEdit_cost_All(QString)));
    connect(ui->lineEdit_cost_Cooler, SIGNAL(textChanged(QString)),
            this, SLOT(calculate_lineEdit_cost_All(QString)));
    connect(ui->lineEdit_cost_PSU, SIGNAL(textChanged(QString)),
            this, SLOT(calculate_lineEdit_cost_All(QString)));
    connect(ui->lineEdit_cost_RAM, SIGNAL(textChanged(QString)),
            this, SLOT(calculate_lineEdit_cost_All(QString)));
    connect(ui->lineEdit_cost_HDD1, SIGNAL(textChanged(QString)),
            this, SLOT(calculate_lineEdit_cost_All(QString)));
    connect(ui->lineEdit_cost_HDD2, SIGNAL(textChanged(QString)),
            this, SLOT(calculate_lineEdit_cost_All(QString)));
    connect(ui->lineEdit_cost_HDD3, SIGNAL(textChanged(QString)),
            this, SLOT(calculate_lineEdit_cost_All(QString)));
    connect(ui->lineEdit_cost_HDD4, SIGNAL(textChanged(QString)),
            this, SLOT(calculate_lineEdit_cost_All(QString)));
    connect(ui->lineEdit_cost_Video, SIGNAL(textChanged(QString)),
            this, SLOT(calculate_lineEdit_cost_All(QString)));
    connect(ui->lineEdit_cost_DVD, SIGNAL(textChanged(QString)),
            this, SLOT(calculate_lineEdit_cost_All(QString)));
    connect(ui->lineEdit_cost_Reader, SIGNAL(textChanged(QString)),
            this, SLOT(calculate_lineEdit_cost_All(QString)));
    connect(ui->lineEdit_cost_KB, SIGNAL(textChanged(QString)),
            this, SLOT(calculate_lineEdit_cost_All(QString)));
    connect(ui->lineEdit_cost_Mouse, SIGNAL(textChanged(QString)),
            this, SLOT(calculate_lineEdit_cost_All(QString)));
    connect(ui->lineEdit_cost_OS, SIGNAL(textChanged(QString)),
            this, SLOT(calculate_lineEdit_cost_All(QString)));
    connect(ui->lineEdit_cost_Lic, SIGNAL(textChanged(QString)),
            this, SLOT(calculate_lineEdit_cost_All(QString)));
    connect(ui->lineEdit_cost_Soft1, SIGNAL(textChanged(QString)),
            this, SLOT(calculate_lineEdit_cost_All(QString)));
    connect(ui->lineEdit_cost_Soft2, SIGNAL(textChanged(QString)),
            this, SLOT(calculate_lineEdit_cost_All(QString)));
    connect(ui->lineEdit_cost_Other1, SIGNAL(textChanged(QString)),
            this, SLOT(calculate_lineEdit_cost_All(QString)));
    connect(ui->lineEdit_cost_Other2, SIGNAL(textChanged(QString)),
            this, SLOT(calculate_lineEdit_cost_All(QString)));
    connect(ui->lineEdit_cost_Other3, SIGNAL(textChanged(QString)),
            this, SLOT(calculate_lineEdit_cost_All(QString)));
    connect(ui->lineEdit_cost_Other4, SIGNAL(textChanged(QString)),
            this, SLOT(calculate_lineEdit_cost_All(QString)));

    connect(ui->lineEdit_price_MB, SIGNAL(textChanged(QString)),
            this, SLOT(calculate_lineEdit_price_All(QString)));
    connect(ui->lineEdit_price_Case, SIGNAL(textChanged(QString)),
            this, SLOT(calculate_lineEdit_price_All(QString)));
    connect(ui->lineEdit_price_CPU, SIGNAL(textChanged(QString)),
            this, SLOT(calculate_lineEdit_price_All(QString)));
    connect(ui->lineEdit_price_Cooler, SIGNAL(textChanged(QString)),
            this, SLOT(calculate_lineEdit_price_All(QString)));
    connect(ui->lineEdit_price_PSU, SIGNAL(textChanged(QString)),
            this, SLOT(calculate_lineEdit_price_All(QString)));
    connect(ui->lineEdit_price_RAM, SIGNAL(textChanged(QString)),
            this, SLOT(calculate_lineEdit_price_All(QString)));
    connect(ui->lineEdit_price_HDD1, SIGNAL(textChanged(QString)),
            this, SLOT(calculate_lineEdit_price_All(QString)));
    connect(ui->lineEdit_price_HDD2, SIGNAL(textChanged(QString)),
            this, SLOT(calculate_lineEdit_price_All(QString)));
    connect(ui->lineEdit_price_HDD3, SIGNAL(textChanged(QString)),
            this, SLOT(calculate_lineEdit_price_All(QString)));
    connect(ui->lineEdit_price_HDD4, SIGNAL(textChanged(QString)),
            this, SLOT(calculate_lineEdit_price_All(QString)));
    connect(ui->lineEdit_price_Video, SIGNAL(textChanged(QString)),
            this, SLOT(calculate_lineEdit_price_All(QString)));
    connect(ui->lineEdit_price_DVD, SIGNAL(textChanged(QString)),
            this, SLOT(calculate_lineEdit_price_All(QString)));
    connect(ui->lineEdit_price_Reader, SIGNAL(textChanged(QString)),
            this, SLOT(calculate_lineEdit_price_All(QString)));
    connect(ui->lineEdit_price_KB, SIGNAL(textChanged(QString)),
            this, SLOT(calculate_lineEdit_price_All(QString)));
    connect(ui->lineEdit_price_Mouse, SIGNAL(textChanged(QString)),
            this, SLOT(calculate_lineEdit_price_All(QString)));
    connect(ui->lineEdit_price_OS, SIGNAL(textChanged(QString)),
            this, SLOT(calculate_lineEdit_price_All(QString)));
    connect(ui->lineEdit_price_Lic, SIGNAL(textChanged(QString)),
            this, SLOT(calculate_lineEdit_price_All(QString)));
    connect(ui->lineEdit_price_Soft1, SIGNAL(textChanged(QString)),
            this, SLOT(calculate_lineEdit_price_All(QString)));
    connect(ui->lineEdit_price_Soft2, SIGNAL(textChanged(QString)),
            this, SLOT(calculate_lineEdit_price_All(QString)));
    connect(ui->lineEdit_price_Other1, SIGNAL(textChanged(QString)),
            this, SLOT(calculate_lineEdit_price_All(QString)));
    connect(ui->lineEdit_price_Other2, SIGNAL(textChanged(QString)),
            this, SLOT(calculate_lineEdit_price_All(QString)));
    connect(ui->lineEdit_price_Other3, SIGNAL(textChanged(QString)),
            this, SLOT(calculate_lineEdit_price_All(QString)));
    connect(ui->lineEdit_price_Other4, SIGNAL(textChanged(QString)),
            this, SLOT(calculate_lineEdit_price_All(QString)));

    connect(ui->spinBox_quantity, SIGNAL(valueChanged(QString)),
            this, SLOT(on_lineEdit_cost_All_textChanged(QString)));
    connect(ui->spinBox_quantity, SIGNAL(valueChanged(QString)),
            this, SLOT(on_lineEdit_price_All_textChanged(QString)));

    connect(ui->lineEdit_price_Total, SIGNAL(textChanged(QString)),
            this, SLOT(on_lineEdit_cost_Total_textChanged(QString)));

    ComponentsArray = new const QList<Component*>*[arrayCount];
                                             ...
                                             const QDoubleSpinBox* cardReaderPriceDSpinbox)
{
    ...
    delete[] this->ComponentsArray;
    this->ComponentsArray = ComponentsArray;

    this->cardReaderPriceDSpinbox = cardReaderPriceDSpinbox;
}
...
void ConfiguratorWidget::refreshCombobox(QComboBox* box, int compArrIndex, bool isRequired)
{
    ...
    foreach(Component* comp, *(this->ComponentsArray[compArrIndex]))
    {
...
void ConfiguratorWidget::refreshCostAndPrice(QLineEdit* lineCost, QLineEdit* linePrice,
                                             QComboBox* curItem, QSpinBox* quantity)
{
    ...
    if(ptrItem != NULL)
    {
        double cost = ptrItem->getCost() * (double)quant;
        double price = ptrItem->getPrice() * (double)quant;

        lineCost->setText(QString::number(cost, 'f', 2));
        linePrice->setText(QString::number(price, 'f', 2));
    }
    else
    {
        lineCost->setText("");
...
void ConfiguratorWidget::on_comboBox_MB_currentIndexChanged(const QString &arg1)
{
    ...
    refreshCostAndPrice(ui->lineEdit_cost_MB, ui->lineEdit_price_MB,
                        ui->comboBox_MB, NULL);
}
...
void ConfiguratorWidget::on_comboBox_Case_currentIndexChanged(const QString &arg1)
{
    ...
    refreshCostAndPrice(ui->lineEdit_cost_Case, ui->lineEdit_price_Case,
                        ui->comboBox_Case, NULL);
}
...
void ConfiguratorWidget::on_comboBox_CPU_currentIndexChanged(const QString &arg1)
{
    ...
    refreshCostAndPrice(ui->lineEdit_cost_CPU, ui->lineEdit_price_CPU,
                        ui->comboBox_CPU, NULL);
}
...
void ConfiguratorWidget::on_comboBox_Cooler_currentIndexChanged(const QString &arg1)
{
    ...
    refreshCostAndPrice(ui->lineEdit_cost_Cooler, ui->lineEdit_price_Cooler,
                        ui->comboBox_Cooler, NULL);
}
...
void ConfiguratorWidget::on_comboBox_PSU_currentIndexChanged(const QString &arg1)
{
    ...
    if(checkPSU())
    {
        ...
        refreshCostAndPrice(ui->lineEdit_cost_PSU, ui->lineEdit_price_PSU,
                            ui->comboBox_PSU, NULL);
    }
    else
    {
        //qDebug() << "false";
...
void ConfiguratorWidget::on_comboBox_RAM_currentIndexChanged(const QString &arg1)
{
    ...
    if(checkRAM())
    {
        ...
        refreshCostAndPrice(ui->lineEdit_cost_RAM, ui->lineEdit_price_RAM,
                            ui->comboBox_RAM, ui->spinBox_RAM);
    }
    else
    {
        //qDebug() << "false";
...
void ConfiguratorWidget::on_comboBox_HDD1_currentIndexChanged(const QString &arg1)
{
    ...
    {
        //qDebug() << "true";
        refreshCostAndPrice(ui->lineEdit_cost_HDD1, ui->lineEdit_price_HDD1,
                            ui->comboBox_HDD1, ui->spinBox_HDD1);
...
void ConfiguratorWidget::on_comboBox_HDD2_currentIndexChanged(const QString &arg1)
{
    ...
    {
        //qDebug() << "true";
        refreshCostAndPrice(ui->lineEdit_cost_HDD2, ui->lineEdit_price_HDD2,
                            ui->comboBox_HDD2, ui->spinBox_HDD2);
...
void ConfiguratorWidget::on_comboBox_HDD3_currentIndexChanged(const QString &arg1)
{
    ...
    {
        //qDebug() << "true";
        refreshCostAndPrice(ui->lineEdit_cost_HDD3, ui->lineEdit_price_HDD3,
                            ui->comboBox_HDD3, ui->spinBox_HDD3);
...
void ConfiguratorWidget::on_comboBox_HDD4_currentIndexChanged(const QString &arg1)
{
    ...
    {
        //qDebug() << "true";
        refreshCostAndPrice(ui->lineEdit_cost_HDD4, ui->lineEdit_price_HDD4,
                            ui->comboBox_HDD4, ui->spinBox_HDD4);
...
void ConfiguratorWidget::on_comboBox_Video_currentIndexChanged(const QString &arg1)
{
    ...
    {
        //qDebug() << "true";
        refreshCostAndPrice(ui->lineEdit_cost_Video, ui->lineEdit_price_Video,
                            ui->comboBox_Video, ui->spinBox_Video);
...
void ConfiguratorWidget::on_comboBox_DVD_currentIndexChanged(const QString &arg1)
{
    ...
    {
        //qDebug() << "true";
        refreshCostAndPrice(ui->lineEdit_cost_DVD, ui->lineEdit_price_DVD,
                            ui->comboBox_DVD, ui->spinBox_DVD);
...
void ConfiguratorWidget::on_checkBox_Reader_stateChanged(int arg1)
{
    if(arg1)
    {
        double price = cardReaderPriceDSpinbox->value();
        ui->lineEdit_cost_Reader->setText(QString::number(price, 'f', 2));
        ui->lineEdit_price_Reader->setText(QString::number(price, 'f', 2));
    }
    else
    {
        ui->lineEdit_cost_Reader->setText("");
        ui->lineEdit_price_Reader->setText("");
    }
}
...
void ConfiguratorWidget::on_comboBox_KB_currentIndexChanged(const QString &arg1)
{
    ...
    {
        //qDebug() << "true";
        refreshCostAndPrice(ui->lineEdit_cost_KB, ui->lineEdit_price_KB,
                            ui->comboBox_KB, ui->spinBox_KB);
...
void ConfiguratorWidget::on_comboBox_Mouse_currentIndexChanged(const QString &arg1)
{
    ...
    {
        //qDebug() << "true";
        refreshCostAndPrice(ui->lineEdit_cost_Mouse, ui->lineEdit_price_Mouse,
                            ui->comboBox_Mouse, ui->spinBox_Mouse);
...
void ConfiguratorWidget::on_comboBox_OS_currentIndexChanged(const QString &arg1)
{
    ...
    refreshCostAndPrice(ui->lineEdit_cost_OS, ui->lineEdit_price_OS,
                        ui->comboBox_OS, ui->spinBox_OS);
}
...
void ConfiguratorWidget::on_comboBox_Lic_currentIndexChanged(const QString &arg1)
{
    ...
    refreshCostAndPrice(ui->lineEdit_cost_Lic, ui->lineEdit_price_Lic,
                        ui->comboBox_Lic, ui->spinBox_Lic);
}
...
void ConfiguratorWidget::on_comboBox_Soft1_currentIndexChanged(const QString &arg1)
{
    ...
    refreshCostAndPrice(ui->lineEdit_cost_Soft1, ui->lineEdit_price_Soft1,
                        ui->comboBox_Soft1, ui->spinBox_Soft1);
}
...
void ConfiguratorWidget::on_comboBox_Soft2_currentIndexChanged(const QString &arg1)
{
    ...
    refreshCostAndPrice(ui->lineEdit_cost_Soft2, ui->lineEdit_price_Soft2,
                        ui->comboBox_Soft2, ui->spinBox_Soft2);
}
...
void ConfiguratorWidget::on_comboBox_Other1_currentIndexChanged(const QString &arg1)
{
    ...
    {
        //qDebug() << "true";
        refreshCostAndPrice(ui->lineEdit_cost_Other1, ui->lineEdit_price_Other1,
                            ui->comboBox_Other1, ui->spinBox_Other1);
...
void ConfiguratorWidget::on_comboBox_Other2_currentIndexChanged(const QString &arg1)
{
    ...
    {
        //qDebug() << "true";
        refreshCostAndPrice(ui->lineEdit_cost_Other2, ui->lineEdit_price_Other2,
                            ui->comboBox_Other2, ui->spinBox_Other2);
...
void ConfiguratorWidget::on_comboBox_Other3_currentIndexChanged(const QString &arg1)
{
    ...
    {
        //qDebug() << "true";
        refreshCostAndPrice(ui->lineEdit_cost_Other3, ui->lineEdit_price_Other3,
                            ui->comboBox_Other3, ui->spinBox_Other3);
...
void ConfiguratorWidget::on_comboBox_Other4_currentIndexChanged(const QString &arg1)
{
    ...
    {
        //qDebug() << "true";
        refreshCostAndPrice(ui->lineEdit_cost_Other4, ui->lineEdit_price_Other4,
                            ui->comboBox_Other4, ui->spinBox_Other4);
...
void ConfiguratorWidget::calculate_lineEdit_cost_All(const QString &arg1)
{
    Q_UNUSED(arg1)

    double mbCost = ui->lineEdit_cost_MB->text().toDouble();
    double caseCost = ui->lineEdit_cost_Case->text().toDouble();
    double cpuCost = ui->lineEdit_cost_CPU->text().toDouble();
    double coolerCost = ui->lineEdit_cost_Cooler->text().toDouble();
    double psuCost = ui->lineEdit_cost_PSU->text().toDouble();
    double ramCost = ui->lineEdit_cost_RAM->text().toDouble();
    double hdd1Cost = ui->lineEdit_cost_HDD1->text().toDouble();
    double hdd2Cost = ui->lineEdit_cost_HDD2->text().toDouble();
    double hdd3Cost = ui->lineEdit_cost_HDD3->text().toDouble();
    double hdd4Cost = ui->lineEdit_cost_HDD4->text().toDouble();
    double videoCost = ui->lineEdit_cost_Video->text().toDouble();
    double dvdCost = ui->lineEdit_cost_DVD->text().toDouble();
    double readerCost = ui->lineEdit_cost_Reader->text().toDouble();
    double kbCost = ui->lineEdit_cost_KB->text().toDouble();
    double mouseCost = ui->lineEdit_cost_Mouse->text().toDouble();
    double osCost = ui->lineEdit_cost_OS->text().toDouble();
    double licCost = ui->lineEdit_cost_Lic->text().toDouble();
    double soft1Cost = ui->lineEdit_cost_Soft1->text().toDouble();
    double soft2Cost = ui->lineEdit_cost_Soft2->text().toDouble();
    double other1Cost = ui->lineEdit_cost_Other1->text().toDouble();
    double other2Cost = ui->lineEdit_cost_Other2->text().toDouble();
    double other3Cost = ui->lineEdit_cost_Other3->text().toDouble();
    double other4Cost = ui->lineEdit_cost_Other4->text().toDouble();

    double result = mbCost + caseCost + cpuCost + coolerCost + psuCost +
                    ramCost + hdd1Cost + hdd2Cost + hdd3Cost + hdd4Cost +
                    videoCost + dvdCost + readerCost + kbCost + mouseCost +
                    osCost + licCost + soft1Cost + soft2Cost +
                    other1Cost + other2Cost + other3Cost + other4Cost;
    ui->lineEdit_cost_All->setText(QString::number(result, 'f', 2));
}

void ConfiguratorWidget::calculate_lineEdit_price_All(const QString &arg1)
{
    Q_UNUSED(arg1)

    double mbPrice = ui->lineEdit_price_MB->text().toDouble();
    double casePrice = ui->lineEdit_price_Case->text().toDouble();
    double cpuPrice = ui->lineEdit_price_CPU->text().toDouble();
    double coolerPrice = ui->lineEdit_price_Cooler->text().toDouble();
    double psuPrice = ui->lineEdit_price_PSU->text().toDouble();
    double ramPrice = ui->lineEdit_price_RAM->text().toDouble();
    double hdd1Price = ui->lineEdit_price_HDD1->text().toDouble();
    double hdd2Price = ui->lineEdit_price_HDD2->text().toDouble();
    double hdd3Price = ui->lineEdit_price_HDD3->text().toDouble();
    double hdd4Price = ui->lineEdit_price_HDD4->text().toDouble();
    double videoPrice = ui->lineEdit_price_Video->text().toDouble();
    double dvdPrice = ui->lineEdit_price_DVD->text().toDouble();
    double readerPrice = ui->lineEdit_price_Reader->text().toDouble();
    double kbPrice = ui->lineEdit_price_KB->text().toDouble();
    double mousePrice = ui->lineEdit_price_Mouse->text().toDouble();
    double osPrice = ui->lineEdit_price_OS->text().toDouble();
    double licPrice = ui->lineEdit_price_Lic->text().toDouble();
    double soft1Price = ui->lineEdit_price_Soft1->text().toDouble();
    double soft2Price = ui->lineEdit_price_Soft2->text().toDouble();
    double other1Price = ui->lineEdit_price_Other1->text().toDouble();
    double other2Price = ui->lineEdit_price_Other2->text().toDouble();
    double other3Price = ui->lineEdit_price_Other3->text().toDouble();
    double other4Price = ui->lineEdit_price_Other4->text().toDouble();
...
void ConfiguratorWidget::on_lineEdit_cost_All_textChanged(const QString &arg1)
{
    Q_UNUSED(arg1)

    double allCost = ui->lineEdit_cost_All->text().toDouble();
    double result = allCost * ui->spinBox_quantity->value();
    ui->lineEdit_cost_Total->setText(QString::number(result, 'f', 2));
}
...
void ConfiguratorWidget::on_lineEdit_cost_Total_textChanged(const QString &arg1)
{
    Q_UNUSED(arg1)

    double totalCost = ui->lineEdit_cost_Total->text().toDouble();
    double totalPrice = ui->lineEdit_price_Total->text().toDouble();

    double result = totalPrice - totalCost;
    ui->lineEdit_profit->setText(QString::number(result, 'f', 2));

    result = ((totalPrice - totalCost) / totalPrice) * 100;
    ui->lineEdit_margin->setText(QString::number(result, 'f', 2) + '%');
}
...
void ConfiguratorWidget::on_pushButton_offer_clicked()
{
    ...
    if(ui->radioButton_txt->isChecked())
        offer = QFileDialog::getSaveFileName(this, "Сохранение коммерческого предложения",
                                             dir.filePath(curDate + "_КП" +
...
void ConfiguratorWidget::saveOfferToTxt(QString fileName)
{
    ...
    if(file.open(QIODevice::WriteOnly | QIODevice::Text))
    {
        ...
        stream << endl << qSetFieldWidth(71) << center <<
                  QString("Коммерческое предложение №" + QString::number(offerNumber) +
        ...
        stream << QString("Итоговая стоимость: ") << ui->lineEdit_price_Total->text() <<
                  QString(" USD(в том числе НДС: ") <<
                  QString::number(ndsPerAll, 'f', 2) << QString(" USD).") << endl << endl;

        stream << QString("Данное коммерческое предложение действительно в течении 3-х дней.");
...
void ConfiguratorWidget::printTextToBookmark(QAxObject* activeDoc, QString bookmarkName,
                                             QString text)
{
    QAxObject *bookmarks = activeDoc->querySubObject("Bookmarks()");
    QAxObject *bookmark = bookmarks->querySubObject("Item(Qstring)", bookmarkName);
    QAxObject *range = bookmark->querySubObject("Range");
    range->dynamicCall("Text", text);
...
QString ConfiguratorWidget::getComponentForDoc(QComboBox *combobox, bool isTemplateExist,
                                               QSpinBox *spinbox)
{
    int quantity = 0;
    if(spinbox == NULL)
    ...
    if(isTemplateExist)
        result = QString("; %1 - %2 шт.").arg(combobox->currentText())
                                                 .arg(QString::number(quantity));
    else
        result = QString("\r\n%1 - %2 шт.").arg(combobox->currentText())
                                                   .arg(QString::number(quantity));
    return result;
}

QString ConfiguratorWidget::getOptionalComponentForDoc(QComboBox *combobox, bool isTemplateExist,
                                                    QSpinBox *spinbox)
{
    QString result;
    if(combobox->currentText() != "---")
    {
        result = getComponentForDoc(combobox, isTemplateExist, spinbox);
    }
    return result;
}

QString ConfiguratorWidget::getAllComponentsForDoc(bool isTemplateExist)
{
    Platform* curPlatform = ui->comboBox_Platform->currentData().value<Platform*>();
    if(curPlatform == NULL)
    {
    ...
    result.append(getComponentForDoc(ui->comboBox_Case, isTemplateExist));
    result.append(getComponentForDoc(ui->comboBox_CPU, isTemplateExist));
    result.append(getComponentForDoc(ui->comboBox_Cooler, isTemplateExist));
    if(curPlatform->getIntegrPsu())
    {
        if(isTemplateExist)
            result.append(QString("; Встроенный БП(%1 Вт) - 1 шт.")
    ...
    {
        result.append(getComponentForDoc(ui->comboBox_PSU, isTemplateExist));
    }
    result.append(getComponentForDoc(ui->comboBox_RAM, isTemplateExist, ui->spinBox_RAM));
    result.append(getComponentForDoc(ui->comboBox_HDD1, isTemplateExist, ui->spinBox_HDD1));

    result.append(getOptionalComponentForDoc(ui->comboBox_HDD2, isTemplateExist,
                                             ui->spinBox_HDD2));
    result.append(getOptionalComponentForDoc(ui->comboBox_HDD3, isTemplateExist,
                                             ui->spinBox_HDD3));
    result.append(getOptionalComponentForDoc(ui->comboBox_HDD4, isTemplateExist,
                                             ui->spinBox_HDD4));
    result.append(getOptionalComponentForDoc(ui->comboBox_Video, isTemplateExist,
                                             ui->spinBox_Video));
    result.append(getOptionalComponentForDoc(ui->comboBox_DVD, isTemplateExist,
                                             ui->spinBox_DVD));
    if(ui->checkBox_Reader->isChecked())
    {
        if(isTemplateExist)
            result.append("; Стандартный картридер - 1 шт.");
        else
            result.append("\r\nСтандартный картридер - 1 шт.");
    }
    result.append(getOptionalComponentForDoc(ui->comboBox_KB, isTemplateExist,
                                             ui->spinBox_KB));
    result.append(getOptionalComponentForDoc(ui->comboBox_Mouse, isTemplateExist,
                                             ui->spinBox_Mouse));
    result.append(getOptionalComponentForDoc(ui->comboBox_OS, isTemplateExist,
                                             ui->spinBox_OS));
    result.append(getOptionalComponentForDoc(ui->comboBox_Lic, isTemplateExist,
                                             ui->spinBox_Lic));
    result.append(getOptionalComponentForDoc(ui->comboBox_Soft1, isTemplateExist,
                                             ui->spinBox_Soft1));
    result.append(getOptionalComponentForDoc(ui->comboBox_Soft2, isTemplateExist,
                                             ui->spinBox_Soft2));
    result.append(getOptionalComponentForDoc(ui->comboBox_Other1, isTemplateExist,
                                             ui->spinBox_Other1));
    result.append(getOptionalComponentForDoc(ui->comboBox_Other2, isTemplateExist,
                                             ui->spinBox_Other2));
    result.append(getOptionalComponentForDoc(ui->comboBox_Other3, isTemplateExist,
                                             ui->spinBox_Other3));
    result.append(getOptionalComponentForDoc(ui->comboBox_Other4, isTemplateExist,
                                             ui->spinBox_Other4));
    return result;
}
...
void ConfiguratorWidget::saveOfferToDoc(QString fileName)
{
    ...
    QFile file(QDir::current().filePath("offer_template.dot"));
    if(file.exists())
    {
        //создание файла по шаблону
        QString fName = file.fileName();
        QAxObject* wordDocuments = wordApplication->querySubObject( "Documents()" );
        QAxObject* newDocument = wordDocuments->querySubObject("Add(const QString&)", fName);

        //активация созданного документа
        QAxObject* activeDocument = wordApplication->querySubObject("ActiveDocument()");

        //добавление своего текста в закладки
        printTextToBookmark(activeDocument, "numberAndDate",
                            QString("№" + QString::number(offerNumber) + " от " + curDate));
        printTextToBookmark(activeDocument, "platform", ui->comboBox_Platform->currentText());
        printTextToBookmark(activeDocument, "components", getAllComponentsForDoc(true));
        printTextToBookmark(activeDocument, "quantity",
                            QString::number(ui->spinBox_quantity->value()));
        printTextToBookmark(activeDocument, "pricePerOne", ui->lineEdit_price_All->text());
        printTextToBookmark(activeDocument, "priceTotal", ui->lineEdit_price_Total->text());
        printTextToBookmark(activeDocument, "pricePerOne_end", ui->lineEdit_price_All->text());
        printTextToBookmark(activeDocument, "ndsPerOne", QString::number(ndsPerOne, 'f', 2));
        printTextToBookmark(activeDocument, "priceTotal_end", ui->lineEdit_price_Total->text());
        printTextToBookmark(activeDocument, "ndsTotal", QString::number(ndsPerAll, 'f', 2));
    ...
    {
        qDebug() << "нет шаблона";
        int ret = QMessageBox::question(this, "Отсутствует шаблон",
                                        "Отутствует шаблон для документа(offer_template.dot)."
                                        " Данные будут выведены построчно. Продолжить?",
                                        "Да", "Нет",  0, 1);
        if(ret == 0)
        {
            qDebug() << "да";
            ...
            selection->dynamicCall("TypeText(Text)",
                                   QString("Коммерческое предложение №" +
            ...
            selection->dynamicCall("TypeText(Text)",
                                   QString(ui->comboBox_Platform->currentText()) + ": ");

            //компоненты
            selection->dynamicCall("TypeParagraph()");
            font->dynamicCall("SetBold(int)", 0);
            selection->dynamicCall("TypeText(Text)", getAllComponentsForDoc(false));
            ...
            selection->dynamicCall("TypeParagraph()");
            font->dynamicCall("SetBold(int)", 0);
            selection->dynamicCall("TypeText(Text)", "Данное коммерческое предложение "
                                                     "действительно в течении 3-х дней");
