...
public:
    ...
    void editPlatform(QString description, QString chipset, int socket, QString sound, QString lan,
                      short usb2, short usb3, short sata, short sata3, short dimm, short ram,
                      bool integrVideo, bool vga, bool dvi, bool hdmi, short pcie1, short pcie4,
                      short pcie8, short pcie16, short ps2, QString caseForm, short ext5_25,
    ...
    friend QDataStream &operator <<(QDataStream &stream, const Platform* platf);
