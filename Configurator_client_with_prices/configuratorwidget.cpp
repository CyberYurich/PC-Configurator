...
void ConfiguratorWidget::refreshPrice(QLineEdit* linePrice, QComboBox* curItem, QSpinBox* quantity)
{
...
void ConfiguratorWidget::on_comboBox_MB_currentIndexChanged(const QString &arg1)
{
    ...
    refreshPrice(ui->lineEdit_price_MB, ui->comboBox_MB, NULL);
}
...
void ConfiguratorWidget::on_comboBox_Case_currentIndexChanged(const QString &arg1)
{
    ...
    refreshPrice(ui->lineEdit_price_Case, ui->comboBox_Case, NULL);
}
...
void ConfiguratorWidget::on_comboBox_CPU_currentIndexChanged(const QString &arg1)
{
    ...
    refreshPrice(ui->lineEdit_price_CPU, ui->comboBox_CPU, NULL);
}
...
void ConfiguratorWidget::on_comboBox_Cooler_currentIndexChanged(const QString &arg1)
{
    ...
    refreshPrice(ui->lineEdit_price_Cooler, ui->comboBox_Cooler, NULL);
}
...
void ConfiguratorWidget::on_comboBox_PSU_currentIndexChanged(const QString &arg1)
{
    ...
    if(checkPSU())
    {
        ...
        refreshPrice(ui->lineEdit_price_PSU, ui->comboBox_PSU, NULL);
    }
    else
    {
        //qDebug() << "false";
...
void ConfiguratorWidget::on_comboBox_RAM_currentIndexChanged(const QString &arg1)
{
    ...
    if(checkRAM())
    {
        ...
        refreshPrice(ui->lineEdit_price_RAM, ui->comboBox_RAM, ui->spinBox_RAM);
    }
    else
    {
        //qDebug() << "false";
...
void ConfiguratorWidget::on_comboBox_HDD1_currentIndexChanged(const QString &arg1)
{
    ...
    {
        //qDebug() << "true";
        refreshPrice(ui->lineEdit_price_HDD1, ui->comboBox_HDD1, ui->spinBox_HDD1);
...
void ConfiguratorWidget::on_comboBox_HDD2_currentIndexChanged(const QString &arg1)
{
    ...
    {
        //qDebug() << "true";
        refreshPrice(ui->lineEdit_price_HDD2, ui->comboBox_HDD2, ui->spinBox_HDD2);
...
void ConfiguratorWidget::on_comboBox_HDD3_currentIndexChanged(const QString &arg1)
{
    ...
    {
        //qDebug() << "true";
        refreshPrice(ui->lineEdit_price_HDD3, ui->comboBox_HDD3, ui->spinBox_HDD3);
...
void ConfiguratorWidget::on_comboBox_HDD4_currentIndexChanged(const QString &arg1)
{
    ...
    {
        //qDebug() << "true";
        refreshPrice(ui->lineEdit_price_HDD4, ui->comboBox_HDD4, ui->spinBox_HDD4);
...
void ConfiguratorWidget::on_comboBox_Video_currentIndexChanged(const QString &arg1)
{
    ...
    {
        //qDebug() << "true";
        refreshPrice(ui->lineEdit_price_Video, ui->comboBox_Video, ui->spinBox_Video);
...
void ConfiguratorWidget::on_comboBox_DVD_currentIndexChanged(const QString &arg1)
{
    ...
    {
        //qDebug() << "true";
        refreshPrice(ui->lineEdit_price_DVD, ui->comboBox_DVD, ui->spinBox_DVD);
...
void ConfiguratorWidget::on_checkBox_Reader_stateChanged(int arg1)
{
    if(arg1)
    {
        ui->lineEdit_price_Reader->setText(QString::number(cardReaderPrice, 'f', 2));
    }
    else
    {
...
void ConfiguratorWidget::on_comboBox_KB_currentIndexChanged(const QString &arg1)
{
    ...
    {
        //qDebug() << "true";
        refreshPrice(ui->lineEdit_price_KB, ui->comboBox_KB, ui->spinBox_KB);
...
void ConfiguratorWidget::on_comboBox_Mouse_currentIndexChanged(const QString &arg1)
{
    ...
    {
        //qDebug() << "true";
        refreshPrice(ui->lineEdit_price_Mouse, ui->comboBox_Mouse, ui->spinBox_Mouse);
...
void ConfiguratorWidget::on_comboBox_OS_currentIndexChanged(const QString &arg1)
{
    ...
    refreshPrice(ui->lineEdit_price_OS, ui->comboBox_OS, ui->spinBox_OS);
}
...
void ConfiguratorWidget::on_comboBox_Lic_currentIndexChanged(const QString &arg1)
{
    ...
    refreshPrice(ui->lineEdit_price_Lic, ui->comboBox_Lic, ui->spinBox_Lic);
}
...
void ConfiguratorWidget::on_comboBox_Soft1_currentIndexChanged(const QString &arg1)
{
    ...
    refreshPrice(ui->lineEdit_price_Soft1, ui->comboBox_Soft1, ui->spinBox_Soft1);
}
...
void ConfiguratorWidget::on_comboBox_Soft2_currentIndexChanged(const QString &arg1)
{
    ...
    refreshPrice(ui->lineEdit_price_Soft2, ui->comboBox_Soft2, ui->spinBox_Soft2);
}
...
void ConfiguratorWidget::on_comboBox_Other1_currentIndexChanged(const QString &arg1)
{
    ...
    {
        //qDebug() << "true";
        refreshPrice(ui->lineEdit_price_Other1, ui->comboBox_Other1, ui->spinBox_Other1);
...
void ConfiguratorWidget::on_comboBox_Other2_currentIndexChanged(const QString &arg1)
{
    ...
    {
        //qDebug() << "true";
        refreshPrice(ui->lineEdit_price_Other2, ui->comboBox_Other2, ui->spinBox_Other2);
...
void ConfiguratorWidget::on_comboBox_Other3_currentIndexChanged(const QString &arg1)
{
    ...
    {
        //qDebug() << "true";
        refreshPrice(ui->lineEdit_price_Other3, ui->comboBox_Other3, ui->spinBox_Other3);
...
void ConfiguratorWidget::on_comboBox_Other4_currentIndexChanged(const QString &arg1)
{
    ...
    {
        //qDebug() << "true";
        refreshPrice(ui->lineEdit_price_Other4, ui->comboBox_Other4, ui->spinBox_Other4);
